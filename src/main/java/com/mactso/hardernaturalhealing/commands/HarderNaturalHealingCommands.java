	...
	public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
		...
		dispatcher.register(Commands.literal("hardernaturalhealing")
				...
				.then(Commands.literal("1-MinimumStarvationHealth").then(
								Commands.argument("minimumStarvationHealth", IntegerArgumentType.integer(0, 20))
										.executes(ctx -> {
				...
				.then(Commands.literal("2-healingPerSecond").then(
								Commands.argument("healingPerSecond", DoubleArgumentType.doubleArg(0.25, 10.0))
										.executes(ctx -> {
				...
				.then(Commands.literal("2-attackHealingDelayTicks").then(
								Commands.argument("attackHealingDelayTicks", IntegerArgumentType.integer(0, 3000))
										.executes(ctx -> {
				...
				.then(Commands.literal("2-minimumFoodHealingLevel").then(
								Commands.argument("minimumFoodHealingLevel", DoubleArgumentType.doubleArg(0.0, 22.0))
										.executes(ctx -> {
				...
				.then(Commands.literal("2-healingExhaustionCost").then(
								Commands.argument("healingExhaustionCost", DoubleArgumentType.doubleArg(0.0, 10.0))
										.executes(ctx -> {
				...
				.then(Commands.literal("2-wakeupHealingAmount").then(
								Commands.argument("wakeupHealingAmount", DoubleArgumentType.doubleArg(0.0, 10.0))
										.executes(ctx -> {
				...
				.then(Commands.literal("2-extraExhaustionWhenHurt").then(
								Commands.argument("extraExhaustionWhenHurt", DoubleArgumentType.doubleArg(0.0, 1.0))
										.executes(ctx -> {
